...
#define STRING_CONFIG_H_AUTHOR "Thierry Mulot" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "(v3.1.1)"         // will be shown during bootup in line 2
...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  // TORNADO
  #define  DEFAULT_Kp 16.34 // default 15.35
  #define  DEFAULT_Ki 1.14 // default 1.16
  #define  DEFAULT_Kd 58.57 // default 150.6
...
// :[-1,1]
#define X_HOME_DIR 1  //COMPILATION ERROR WHEN SETTING TO 1 INSTEAD OF -1 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#define Y_HOME_DIR -1
#define Z_HOME_DIR -1
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 15), (Y_MIN_POS + 25), 40 }
